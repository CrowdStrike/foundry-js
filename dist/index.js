...
class Bridge {
     ...
     */
    sendStreamMessage(messageId, message) {
        const eventData = {
            message,
            meta: {
                messageId,
...
class AgentStream {
     ...
     * @internal
     */
    constructor(bridge, request, onFinish) {
        this.bridge = bridge;
...
class AgentWorks {
     ...
     */
    invoke(agentId, params) {
        const stream = new AgentStream(this.bridge, { agentId, params }, () => this.remove(stream));
...
export { AgentStream, AgentWorks, Bridge, FalconApi as default };
