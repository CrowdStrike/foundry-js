...
export type GetQueriesAlertsV2ResponseMessage = BaseApiResponseMessage<GetQueriesAlertsV2ApiResponse>;
export interface GetQueriesAlertsV2RequestMessage extends BaseApiRequestMessage<GetQueriesAlertsV2QueryParams> {
    api: AlertsRequestApi;
...
export type AlertsApiRequestMessage = DeleteEntitiesSuppressedDevicesV1RequestMessage | GetQueriesAlertsV1RequestMessage | GetQueriesAlertsV2RequestMessage | PatchCombinedAlertsV2RequestMessage | PatchCombinedAlertsV3RequestMessage | PatchEntitiesAlertsV2RequestMessage | PatchEntitiesAlertsV3RequestMessage | PatchEntitiesSuppressedDevicesV1RequestMessage | PostAggregatesAlertsV1RequestMessage | PostAggregatesAlertsV2RequestMessage | PostEntitiesAlertsV1RequestMessage | PostEntitiesAlertsV2RequestMessage | PostEntitiesSuppressedDevicesV1RequestMessage;
export type AlertsApiResponseMessage = DeleteEntitiesSuppressedDevicesV1ResponseMessage | GetQueriesAlertsV1ResponseMessage | GetQueriesAlertsV2ResponseMessage | PatchCombinedAlertsV2ResponseMessage | PatchCombinedAlertsV3ResponseMessage | PatchEntitiesAlertsV2ResponseMessage | PatchEntitiesAlertsV3ResponseMessage | PatchEntitiesSuppressedDevicesV1ResponseMessage | PostAggregatesAlertsV1ResponseMessage | PostAggregatesAlertsV2ResponseMessage | PostEntitiesAlertsV1ResponseMessage | PostEntitiesAlertsV2ResponseMessage | PostEntitiesSuppressedDevicesV1ResponseMessage;
export declare class AlertsApiBridge {
    ...
    getQueriesAlertsV2(urlParams?: GetQueriesAlertsV2QueryParams): Promise<GetQueriesAlertsV2ApiResponse>;
    /**
    ...
    patchCombinedAlertsV3(postBody: PatchCombinedAlertsV3PostData, urlParams?: PatchCombinedAlertsV3QueryParams): Promise<PatchCombinedAlertsV3ApiResponse>;
    /**
    ...
    patchEntitiesAlertsV3(postBody: PatchEntitiesAlertsV3PostData, urlParams?: PatchEntitiesAlertsV3QueryParams): Promise<PatchEntitiesAlertsV3ApiResponse>;
    ...
    postAggregatesAlertsV2(postBody: PostAggregatesAlertsV2PostData, urlParams?: PostAggregatesAlertsV2QueryParams): Promise<PostAggregatesAlertsV2ApiResponse>;
    /**
    ...
    postEntitiesAlertsV2(postBody: PostEntitiesAlertsV2PostData, urlParams?: PostEntitiesAlertsV2QueryParams): Promise<PostEntitiesAlertsV2ApiResponse>;
