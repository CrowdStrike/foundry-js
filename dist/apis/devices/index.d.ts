...
export type GetQueriesDevicesV1ResponseMessage = BaseApiResponseMessage<GetQueriesDevicesV1ApiResponse>;
export interface GetQueriesDevicesV1RequestMessage extends BaseApiRequestMessage<GetQueriesDevicesV1QueryParams> {
    api: DevicesRequestApi;
