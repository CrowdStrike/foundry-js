...
export type MessageType = 'connect' | 'navigateTo' | 'loggingapi' | 'api' | 'data' | 'broadcast' | 'fileUpload' | 'collection' | 'livereload' | 'resize' | 'openModal' | 'closeModal' | 'agentWorks';
...
export type RequestMessage = ConnectRequestMessage | NavigateToRequestMessage | CollectionRequestMessage | ApiRequestMessage | FileUploadRequestMessage | LogscaleRequestMessage | OpenModalRequestMessage | AgentWorksRequestMessage;
export { ApiIdentifier };
export type ResponseMessage<DATA extends LocalData = LocalData> = ConnectResponseMessage<DATA> | NavigateToResponseMessage | ApiResponseMessage | DataUpdateMessage<DATA> | BroadcastMessage | FileUploadResponseMessage | CollectionResponseMessage | LivereloadMessage | LogscaleResponseMessage | OpenModalResponseMessage | AgentWorksResponseMessage;
import type { ResponseFor as ApiResponseFor } from './apis/types-response-for';
type ResponseFor<REQ extends RequestMessage, DATA extends LocalData> = REQ extends ConnectRequestMessage ? ConnectResponseMessage<DATA> : REQ extends NavigateToRequestMessage ? NavigateToResponseMessage : REQ extends CollectionRequestMessage ? CollectionResponseMessage : REQ extends LogscaleRequestMessage ? LogscaleResponseMessage : REQ extends FileUploadRequestMessage<infer FILEUPLOADTYPE> ? FileUploadResponseMessage<FILEUPLOADTYPE> : REQ extends OpenModalRequestMessage ? OpenModalResponseMessage : REQ extends AgentWorksRequestMessage ? AgentWorksResponseMessage : ApiResponseFor<REQ>;
export { ResponseFor };
